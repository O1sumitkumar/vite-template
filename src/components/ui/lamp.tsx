...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        // In light mode, use a light (white) background.
        // In dark mode, keep the original dark slate.
        "relative flex min-h-screen flex-col items-center justify-center overflow-hidden w-full rounded-md z-0 bg-background",
        className,
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        >
          {/* The masking layers now switch between white (light mode) and dark (dark mode) */}
